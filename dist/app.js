...
var menuLink = document.getElementById('js-link');
...
var morphingSVG = function morphingSVG(svgPath) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_animejs___default()({
        ...
        duration: 10000,
        easing: [0.5, 0, 0.5, 1],
        d: [{ value: 'M485.4,55.4c132.7,0,243.6,46.2,326.7,127s142,174.3,137.4,288.6S914.9,318,841,706.8S638.6,945,408.3,944.6 c-130.3-0.4-241.1-30.4-338-110.1S50.3,614.1,50.3,283.6s64.6-244.7,154.7-322.1S352.7,55.4,485.4,55.4z' }, { value: 'M485.4,55.4c132.7,0,243.6,46.2,326.7,127s142,174.3,137.4,288.6S914.9,718,841,806.8S638.6,945,508.3,944.6 c-130.3-0.4-241.1-30.4-338-110.1S50.3,614.1,50.3,483.6s64.6-244.7,154.7-322.1S352.7,55.4,485.4,55.4z' }],
        loop: true
    });
};
...
var scrollToSection = function scrollToSection(el) {
    ...
    var mainHeaderHeight = document.getElementById('top').scrollHeight;
