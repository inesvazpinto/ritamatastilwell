...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_toggleMenu__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_scrollPos__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_scrollToBlock__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_morphingSVG__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_Map__ = __webpack_require__(8);
...
App.init = function ($, window, document, undefined) {

	var blocks = $(document).find('.js-block');
	var menu = document.getElementById('js-menu');
	var hamburguerBtn = document.getElementById('js-menu-opener');
	var navLinks = $(document).find('.menu-link');
	...
	var main = function main() {
		...
		$(navLinks).on('click', function () {
			...
			Object(__WEBPACK_IMPORTED_MODULE_4__core_scrollToBlock__["a" /* default */])(this);
			Object(__WEBPACK_IMPORTED_MODULE_2__core_toggleMenu__["a" /* default */])(hamburguerBtn, menu);
			return false;
		});

		Object(__WEBPACK_IMPORTED_MODULE_3__core_scrollPos__["a" /* default */])(blocks, navLinks);

		Object(__WEBPACK_IMPORTED_MODULE_5__core_morphingSVG__["a" /* default */])(svgPath);

		__WEBPACK_IMPORTED_MODULE_6__core_Map__["a" /* default */].init(mapEl, infobox, 38.715021, -9.163152);

		closeInfoxBtn.addEventListener('click', function () {
			return __WEBPACK_IMPORTED_MODULE_6__core_Map__["a" /* default */].toggleBox(infobox);
		});
	};
...
}(__WEBPACK_IMPORTED_MODULE_1_jquery___default.a, window, document);
...
var scrollPos = function scrollPos(sections, navLinks) {
...
var scrollToSection = function scrollToSection(el) {
    ...
    var mainHeaderHeight = document.getElementById('js-main-header').scrollHeight + 20;
...
var morphingSVG = function morphingSVG(svgPath) {
  anime({
    ...
    duration: 4000,
    easing: [0.5, 0, 0.5, 1],
    d: [{ value: 'M83.5,536.9c0-247.5,174.5-480,422-480s485,229.5,485,477s-185.5,429-433,429S83.5,784.4,83.5,536.9z' }, { value: 'M96,492.9c0-247.5,163.5-459,411-459s471,179.5,471,427s-184.5,525-432,525S96,740.4,96,492.9z' }, { value: 'M83.5,536.9c0-247.5,174.5-480,422-480s485,229.5,485,477s-185.5,429-433,429S83.5,784.4,83.5,536.9z' }],
    loop: true
  });
};
